...
/// Small helper view extracted from ConfigView to keep the file compact and
/// provide the SteamCompatibilitySection symbol used by ConfigView.
struct SteamCompatibilitySection: View {
        ...
        Section("Steam Compatibility Layer") {
            if isOptimized {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    Label(
                        "Steam requires compatibility layer optimization",
                    ...
                    Button {
                        ...
                        Text("Enable Steam Compatibility Layer")
