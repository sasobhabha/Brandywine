...
struct ConfigView: View {
    ...
    var body: some View {
        Form {
            ...
            SteamCompatibilitySection(bottle: bottle)
        }
        .formStyle(.grouped)
    ...
    // Provide a local implementation of loadBuildName so the method is available
    // even if the helper file isn't part of this target's compile sources.
    func loadBuildName() {
        Task(priority: .userInitiated) {
            do {
...
// Local SettingItemView implementation used by ConfigView when the separate
// SettingItemView.swift file isn't part of this target's compile sources.
// This mirrors the original view used by the app UI.
