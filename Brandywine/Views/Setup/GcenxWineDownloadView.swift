...
struct GcenxWineDownloadView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            Task {
                if let localArchive = BrandyTheme.localWineArchiveURL,
                   FileManager.default.fileExists(atPath: localArchive.path) {
